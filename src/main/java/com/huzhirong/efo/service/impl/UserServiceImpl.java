...
import com.huzhirong.efo.dao.UserDAO;
...
import com.huzhirong.efo.service.IUserService;
...
public class UserServiceImpl implements IUserService {
    ...
    public boolean register(String username, String email, String password) {
        ...
        if (allowRegister) {
            boolean isValid = Checker.isEmail(email) && checkPassword(password) && Pattern.compile(EfoApplication.settings
